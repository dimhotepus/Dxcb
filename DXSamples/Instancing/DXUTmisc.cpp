...
static bool DXUT_EnsureD3D9APIs( void )
{
    ...
    if( s_hModD3D9 != NULL )
    {
        ...
        //s_DynamicDirect3DCreate9 = Redirecting_Direct3DCreate9;
...
//IDirect3D9 * WINAPI Redirecting_Direct3DCreate9( UINT SDKVersion );

IDirect3D9 * WINAPI DXUT_Dynamic_Direct3DCreate9(UINT SDKVersion) 
{
//    return Redirecting_Direct3DCreate9( SDKVersion );
